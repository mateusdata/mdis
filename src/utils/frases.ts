...
export const frases: Frase[] = [
    ...
    },
    {
        partes: [
            ...
            "muito boa",
            "incluindo",
            "começou a fazer os preparativos para a mudança,",
            "Ele recebeu"
        ],
        ordem: [9, 1, 6, 2, 4, 8, 7, 3, 5]
    },
    {
        partes: [
    ...
    },
    {
        partes: [
            ...
            "dinheiro por meses,",
            "daí",
            "finalmente comprou o carro",
            "dos seus sonhos."
        ],
        ordem: [1, 2, 3, 4, 5] // A ordem correta dos elementos
    },
    {
        partes: [
            "Os ingressos",
    ...
    },
    {
        partes: [
            "Ele se tornou",
            "o mentor de muitos jovens na comunidade,",
            "por assim dizer.",
            "Sempre disponível",
            "para dar conselhos e orientar,",
            "ele desempenha",
            "um papel crucial",
            "no desenvolvimento",
...

    {
        partes: [
            "A internet é",
            "a espinha dorsal",
            "da nossa comunicação moderna,",
            "por assim dizer.",
            "Sem ela,",
            "muitas das nossas atividades diárias",
            "simplesmente não",
            "seriam possíveis."
        ],
        ordem: [1, 2, 3, 4, 5, 6, 7, 8]
    ...
    },
    {
        partes: [
            "A casa",
            "tem um grande quintal e",
            "além disso",
            "está localizada em um bairro",
            "tranquilo"
        ],
        ordem: [1, 2, 3, 4, 5]
    },
