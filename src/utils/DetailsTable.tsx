...
export const data: DataType[] = [
    {
        ...
        escrito: 'a) Ele é cardiologista, ou seja,  especialista em coração. b)Ela mora perto do trabalho, ou seja, não precisa pegar trânsito todos os dias."                                                 c) Ele é vegano, ou seja, não consome nenhum produto de origem animal."  d)O projeto foi aprovado pelo conselho, ou seja, podemos começar a execução imediatamente."',
    ...
    },
    {
      ...
      b) Fiz a prova de manhã, e aí fui comemorar com meus amigos.
      c) O time marcou um gol nos últimos minutos, e aí garantiu a vitória.
      d) Ele saiu do trabalho mais cedo, e aí decidiu passear no parque.`,
    ...
    },
    {
      ...
      b) "Ela não estava se sentindo bem, então foi para casa mais cedo."
      c) "O trânsito estava horrível, então chegamos atrasados na reunião."
      d) "Ele estudou muito para a prova, então conseguiu tirar uma boa nota."`,
      ...
      
    {
      ...
      b) Tivemos vários contratempos durante a viagem, mas, enfim, chegamos ao nosso destino.
      c) "Ela passou por muitas dificuldades, mas, enfim, conseguiu realizar seu sonho."
      d) "Expliquei todos os detalhes do projeto, discutimos as melhorias e, enfim, tomamos uma decisão."`,
    ...
    },
    {
      ...
      b) "Estávamos com fome, daí decidimos pedir uma pizza."
      c) "Ele se machucou jogando futebol, daí foi ao hospital."
      d) "Fizemos todas as compras, daí voltamos para casa."`,
...

    {
        ...
        escrito: `a) "Ele é o líder do grupo, por assim dizer, pois sempre toma as decisões importantes."
b) "O projeto está em seus estágios iniciais, por assim dizer, ainda temos muito a desenvolver."
c) "Ela é a 'mãe' do grupo, por assim dizer, porque sempre cuida de todos."`,
        comentario: 'Nos exemplos a)-c), temos o marcador "por assim dizer" que apresenta uma informação que não deve ser concebida com o significado literal. No caso da letra a), ser "líder de um grupo", deveria haver uma nomeação consensual e clara de um membro como líder do grupo. Entretanto, o "por assim dizer" adverte que esse não é o caso, que a informação apresentada deve ser concebida como uma aproximação ao significado de "líder". A mesma coisa pode-se observar na c). "Ser mãe" é uma ideia atribuída a um membro do grupo porque enxergam seu comportamento com o grupo como o comportamento de uma mãe com seu filho, ainda que ela não seja, de fato, mãe. Na letra b), o "por assim dizer" adverte ao interlocutor que, ainda que se tenha trabalhado muito no projeto ou passado muito tempo nele (o que não se concebe naturalmente como estágio inicial), há muita coisa para desenvolver, como se estivesse no início.',
        oral: {
...

    {
      ...
      b) "A previsão era de chuva, no entanto, o dia amanheceu ensolarado."
      c) "Ele se esforçou bastante no trabalho, no entanto, não foi promovido."
      d) "A equipe trabalhou duro no projeto, no entanto, o cliente não ficou satisfeito com o resultado."`,
        comentario: `Em a), por exemplo, a primeira conclusão a que "estudou muito para a prova" nos leva é que se obtenha uma boa nota. Contudo, o marcador "no entanto" apresenta a conclusão contrária a isso. Em b), o que você menos espera para "A previsão era de chuva" é que o dia amanheça ensolarado. Em c), "no entanto" apresenta uma conclusão não natural. Quem se esforça muito no trabalho, espera ser promovido. Em d), "A equipe trabalhou duro no projeto" leva a concluir que houve um resultado positivo e satisfatório, em primeira instância, contudo, o "no entanto" introduz uma conclusão contrária a essa.`,
        oral: {
    ...
    },
    {
      ...
      b) "A previsão do tempo dizia que faria sol, pelo contrário, choveu o dia inteiro."
      c) "Ela não ficou triste com a notícia, pelo contrário, ficou muito feliz com a novidade."
      d) "O projeto não foi um fracasso, pelo contrário, superou todas as expectativas."`,
        comentario: `Nos exemplos, podemos ver dois membros do discurso opostos conectados por "pelo contrário". Em a), c) e d), o segundo membro, além de se opor ao primeiro, o refuta. Enquanto no exemplo b), temos um contraste entre os dois argumentos, que são opostos.`,
        oral: {
...

    {
      ...
      b) "A empresa oferece ótimos salários e, além disso, benefícios como plano de saúde e vale-alimentação."
      c) "O filme tem uma trama envolvente; além disso, a trilha sonora é incrível."
      d) "Ele é um bom aluno; além disso, participa de várias atividades extracurriculares."`,
        comentario: `Na letra a) o argumento "o projeto foi bem elaborado" nos leva a uma conclusão positiva sobre o resultado desse projeto. O marcador "além disso" apresenta o membro do discurso "teve um excelente feedback dos clientes" para somar para a mesma conclusão, com uma força maior que se fosse o argumento anterior sozinho. Na letra b) o argumento "A empresa oferece ótimos salários" nos leva a concluir que é vantajoso fazer parte dessa empresa no que diz respeito aos benefícios salariais. O marcador "além disso" apresenta o membro do discurso "benefícios como plano de saúde e vale-alimentação" para somar para a mesma conclusão, com uma força maior que se fosse o argumento anterior sozinho. Na letra c) o argumento "O filme tem uma trama envolvente" nos leva a concluir que o filme é interessante. O marcador "além disso" apresenta o membro do discurso "a trilha sonora é incrível" para somar para a mesma conclusão, com uma força maior que se fosse o argumento anterior sozinho. Na letra d), o argumento "ele é um bom aluno" leva a concluir que o aluno é dedicado. O marcador "além disso" apresenta o membro do discurso "participa de várias atividades extracurriculares" para somar para a mesma conclusão, com uma força maior que se fosse o argumento anterior sozinho.`,
        oral: {
    ...
    },
    {
      ...
      b) "Ela não aceitou o convite para a festa, mas de qualquer forma nós nos divertimos muito."
      c) "O resultado do projeto não foi o esperado, mas de qualquer forma aprendemos muito durante o processo."
      d) "Eu não estava me sentindo muito bem, mas de qualquer forma fui trabalhar."`,
        comentario: `Nos exemplos, podemos ver que os argumentos anteriores ao marcador "de qualquer forma" podem levar a diversas conclusões. No a), "não conseguimos reservar mesa no restaurante" pode levar a concluir que não foram ao restaurante ou que escolheram ir a outro, por exemplo; No b), "Ela não aceitou o convite para a festa" pode levar a concluir que a festa não foi como esperavam já que a pessoa convidada não compareceu; No c), "o resultado do projeto não foi o esperado" pode levar a concluir que não houve proveito em trabalhar nele, que o projeto foi uma perda de tempo; No d), "Eu não estava me sentindo muito bem'" pode levar a concluir que a pessoa ficou em casa descansando, teve que ir ao hospital, passou mal, etc. Contudo, o que vemos é que o "de qualquer forma", em cada exemplo dado, apresenta uma conclusão mais relevante do que se poderia inferir, naturalmente, a partir do primeiro membro destacado em cada exemplo.`,
        oral: {
...

    {
      ...
      b) "Você gostou do filme, né?"
      c) "Precisamos terminar esse relatório até amanhã, né?"
      d) "Ela está sempre atrasada, né?"
      e) "Esse restaurante é muito bom, né?"`,
        comentario: `Nos exemplos, as letras a), b), c) e d) apresentam o "né" para que o interlocutor corrobore com seu discurso em um caráter de cumplicidade, enquanto no exemplo c) podemos ver o "né" buscando um caráter cooperativo do interlocutor que pode corroborar com seu discurso.`,
        oral: {
    ...
    },
    {
      ...
      b) "A cidade é conhecida pelas suas praias maravilhosas e, além disso, pela sua gastronomia única."
      c) "A reunião foi muito produtiva e, além disso, conseguimos resolver alguns problemas pendentes."
      d) "Eles são bons amigos e, além disso, são colegas de trabalho na mesma empresa."`,
    ...
    },
    {
      ...
      b) "A festa foi cancelada de última hora e ainda por cima choveu o dia inteiro."
      c) "O carro quebrou na estrada e ainda por cima não tínhamos sinal de celular."
      d) "A conta de luz aumentou muito este mês e ainda por cima tivemos que lidar com uma infiltração em casa."`,
    ...
    },
    {
      ...
      b) "O projeto foi, de fato, concluído dentro do prazo estipulado."
      c) "As mudanças no regulamento são, de fato, necessárias para melhorar o processo."
      d) "Ela estava, de fato, muito nervosa durante a apresentação."`,
    ...
    },
    {
      ...
      b) - "Deseja fazer um pedido? Pois não!"
      c) "Posso te oferecer algo para beber?" - "Pois não, um suco seria ótimo."`,
        comentario: 'Nos exemplos, o "pois não" no a) e c) demonstra confirmação ao membro anterior do discurso, que é uma pergunta. No exemplo b), o marcador demonstra disponibilidade do falante.',
        oral: {
